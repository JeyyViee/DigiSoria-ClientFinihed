...
loadingIndicator: {
  ...
  hideContainer: {
    ...
    marginVertical: 10, // Adds vertical spacing between containers
  ...
  actionButton: {
    ...
    paddingHorizontal: 20, // Horizontal padding for better click area
  ...
  actionButtonText: {
    fontSize: 14, // Balanced text size
    color: '#FFFFFF', // Contrast color for text
    fontWeight: 'bold', // Makes text prominent
  },
  featureContainer: {
    marginTop: 10,
  },
