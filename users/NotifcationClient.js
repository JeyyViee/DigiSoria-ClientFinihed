...
const SimpleNotification = ({ route }) => {
  ...
  const deleteNotification = async (docId, fileURL) => {
    try {
      ...
      await db.collection('sentToClients').doc(docId).delete();
              ...
              <View key={index} style={styles.notificationCard}>
                <View style={styles.cardHeader}>
                  <Text style={styles.cardTitle}>
                    {doc.clientEmail ? 'Transaction' : 'Account Banned'}
                  </Text>
                  <TouchableOpacity
                ...
                <View style={styles.cardContent}>
                  ...
                  {doc.fileURL && (
                    ...
                    >
                      ...
                      <Text style={styles.fileIconText}>Download File</Text>
                    </TouchableOpacity>
                  )}
