...
import styles from '../styles/SellerPosting.styles';
...
const SellerPostingUI = ({
  ...
  const filteredProducts = products
    .filter((item) => !category || item.type === category.toLowerCase())
    .filter((item) => item.name.toLowerCase().includes(searchQuery.toLowerCase())); // Filter based on search query
                  ...
                  <View key={item.id} style={styles.rowContainer}>
                    ...
                    {filteredProducts[index + 1] && (
                      <TouchableOpacity
                        ...
                        onPress={() => navigation.navigate('ProductDetail', { product: filteredProducts[index + 1] })}
                      >
          ...
          >
            ...
            <Dialog.Content style={{ paddingBottom: 20 }}>
              <Paragraph style={{ fontFamily: 'Poppins_400Regular' }}>
                Choose one of the options below to proceed with your product/service management.
              </Paragraph>
            </Dialog.Content>
            <Dialog.Actions
              style={{
            ...
            >
              ...
              <Button
                ...
                icon="eye"
              >
                View Your Created Products/Services
              </Button>
            </Dialog.Actions>
          </Dialog>
        </Portal>
...
export default SellerPostingUI;
